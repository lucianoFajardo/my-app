...
import {
  ...
  plans,
  rangePaymentDates,
} from "../models/select-drops-data-model";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-muted-foreground mt-0.5 text-sm">
                Ingresa la información del cliente para registrar la instalación
                de su servicio de internet. Asegúrate de completar todos los
                campos requeridos antes de enviar el formulario.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="space-y-4 mb-6">
            {isOpenCreated && (
              <Alert className="bg-emerald-50 text-emerald-900 border-emerald-200 shadow-sm animate-in fade-in slide-in-from-top-4 py-3">
                ...
                <AlertTitle className="font-semibold text-emerald-800 text-sm">
                  ¡Creado con éxito!
                </AlertTitle>
            ...
            {isErrorCreated && (
              <Alert
                variant="destructive"
                className="animate-in fade-in slide-in-from-top-4 py-3"
              >
                <AlertCircle className="h-4 w-4" />
                <AlertTitle className="text-sm">¡Error al crear!</AlertTitle>
                <AlertDescription className="text-xs mt-1">
                  Hubo un problema al registrar el cliente. Inténtalo de nuevo.
                </AlertDescription>
              </Alert>
            )}
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  {errors.phone2 && (
                    <span className="text-destructive text-[10px] font-medium">
                      {errors.phone2.type === "pattern" ? "Solo números" : ""}
                    </span>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="bg-background h-9 text-sm"
                    {...register("antenna_name", { required: true })}
                  />
                  {errors.antenna_name && (
                    <span className="text-destructive text-[10px] font-medium">
                      Requerido
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    id="sector"
                    placeholder="Ej. Mula, 18, Hospital, Boro"
                    className="bg-background h-9 text-sm"
                    {...register("sector", {
                      required: true,
                      pattern: /^[a-zA-Z0-9\s,]+$/,
                ...
                <div className="space-y-1.5 sm:col-span-2 mt-1">
                  <Label className="text-xs font-medium text-muted-foreground">
                    Rango de Instalación Programado (5 días)
                  </Label>
                  <Popover>
