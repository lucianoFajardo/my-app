...
import { plans, rangePaymentDates } from "../models/select-drops-data-model";
...
export function CardEditCliente({
  cliente,
  onCancel,
  isOpen,
  onSubmit,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <Label
                    ...
                    className="text-xs font-medium text-muted-foreground"
                  >
                    Rango Fecha de Pago (Anterior: {cliente.initial_payment})
                  </Label>
                  <Select
                    onValueChange={(value) => {
